...
#lab 4
cpu.vhd : mycpu.vhd alu.vhd ander.vhd controller.vhd inverter.vhd luiShifter.vhd lwStateMachine.vhd mux1Bit.vhd mux5Bit.vhd mux32Bit.vhd orer.vhd pcReg.vhd pcUpdate.vhd ramd.vhd rami.vhd registerFile.vhd signExtender.vhd twoInputAdder.vhd bintohexDecoder.vhd
cpuTest.vhd : cpu.vhd
tb_cpu.vhd : cpu.vhd
